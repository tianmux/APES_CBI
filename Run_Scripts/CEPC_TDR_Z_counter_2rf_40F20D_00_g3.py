...
working_folder = 'CEPC/TDR_Z_counter_2rf_40F20D_00_g3'
home = os.getcwd()
print(home)
...
nCav = np.array([40,20])
h = np.array([216816,216816])

RoQ = np.array([213/4,213/4])*nCav
delay = np.array([0,0])
...
Iref_I = np.array([1,1])
Iref_Q = np.array([1,1])
I_I_ref_ini = np.array([1,1])
I_I_ref_final = np.array([1,1])
I_Q_ref_ini = np.array([1,1])
I_Q_ref_final = np.array([1,1])
detune = np.array([0.0,0])
detune_ini = np.array([0.0,0])
detune_mid = np.array([1,1])
detune_final = np.array([1,1])
